...
# 2. Convert the above dictionary into a pandas datafram
...
print(f"Detected ouliers for the 'Age' column:\n{outliers}")
...
# Display the datast after capping outliers for the 'Age' column
