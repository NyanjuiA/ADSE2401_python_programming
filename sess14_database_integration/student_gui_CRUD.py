# Python script to demonstrate MySQL database CRUD operations on the GUI
...
class StudentApp:
    def __init__(self, root):
        ...
        # Student Number
        tk.Label(form_frame, text='Student NO *').grid(row=0, column=0, sticky="e", padx=8, pady=5)
        self.entries = {}
    ...
    def load_all_records(self):
        ...
        try:
            self.cursor.execute(
                "SELECT * FROM student")  # execute("SELECT StudentNO, Name, BirthDate,Gender, City FROM student")
    ...
    def get_form_data(self):
        data = {
            ...
            "birthdate": self.entries["birthdate"].get_date().strftime("%Y-%m-%d"),
        ...
        try:
            ...
            messagebox.showerror("Invalid Data", f"{err}")
            return None
        return data
    ...
    def create_or_update(self):
        ...
        try:
            ...
            if exists:
                ...
                where StudentNO=%s
                """
                params = (data["name"], data["birthdate"], data["gender"], data["city"], data["student_no"])
            else:
                query = """
                INSERT INTO student (StudentNO,Name, BirthDate, Gender, City)
                VALUES(%s, %s, %s, %s, %s)
                """
                params = (data["student_no"], data["name"], data["birthdate"], data["gender"],data["city"])
            ...
            messagebox.showerror("Database Error", f"Unable to save record.\n{err}")
    ...
    def delete_record(self):
        ...
        try:
            ...
            if self.cursor.rowcount > 0:
                ...
                messagebox.showwarning("Record Not Found", "No record with {student_no} found.")
        except mysql.connector.Error as err:
