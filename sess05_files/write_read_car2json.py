...
def save_car_details(file_path: Path, car_list:list):
    ...
    try:
        ...
        printf(f"❌ Sorry, Something went wrong when saving car data.\n{e}")
...
def load_car_details(file_path: Path) -> list:
    ...
    # handle errors/exceptions
        ...
        printf(f"❌ Sorry, the file was not found.\n{fnf}")
        return [] # return an empty list
    except json.decoder.JSONDecodeError as jde:
        printf(f"❌ Sorry, failed to decode the JSON data.\n{jde}")
        return []  # return an empty list
    except Exception as e:
        printf(f"❌ Sorry, error loading car data.\n{e}")
        return [] # return an empty list
