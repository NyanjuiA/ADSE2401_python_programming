# Python script to demonstrate working with comprehensions  1759
...
# Get and display the cubes of the even Fibonaccy numbers above using a list comprehension
...
student_scores = {
    'Sue':56,'Jim':72,'Mark':61,'Micha':55,'William':78,'Jane':51,'Xi':56,'Abigail':92,
}
...
# Get and display the set of student names with 4 or more letters/characters
