"""
Python Sets
A set in Python is a built in type that represents an unordered collection of elements of the same
or different types.
...
# dicard  'cherry' from the fruit set
...
print(f"After copying the remaining fruits to a new set we get: \n{copy_of_fruits}")
...
# Get and display the common fruits in the 'combined_fruits' and 'more_fruit' sets
...
# Check and display whether fruit set is a superset of  "more_fruits"
...
# Create anothe fruit set  and use it to update the set of fruits: CAUTION...overwrites set elements
