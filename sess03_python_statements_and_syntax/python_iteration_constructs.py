...
fruits = ["kiwi", 'watermelon', 'pineapple', "strawberry", 'banana',
          ...
          "date", "tomato", 'avocado', 'apple', 'plums', 'cashew fruits', 'dragon fruit', 'lemon']

# Display each of the above fruits uisng a 'for' loop
for fruit in fruits:
...
for n in range(5):  # Note: basice range starts from 0 to specified number minus 1
    print(f"The current number in the range is: {n}")

print(f"range with parameters".center(42, "-"))
# Generate even numbers starting from 2 to 10 (exclusive) using a range with start, stop and step values
...
n = 1
print("The first five multiple of 8 are:")
while n <= 5:
    print(f"{n} x 8 = {n * 8}")
...
text_to_search = "Pictures".lower() # convert to lower/upper for case insensitive search
found = False
index = 0
