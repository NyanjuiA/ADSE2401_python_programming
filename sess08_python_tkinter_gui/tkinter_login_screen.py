...
def login():
    ...
    if username.strip() == '' or password.strip() == '':  # when any of them is empty
        ...
        return
    if username == 'admin' and password == 'pa$s!1':  # Hard-code the username & password
...
checkbox_show_password = tk.Checkbutton(frame, variable=show_password_var, text="Show password",
