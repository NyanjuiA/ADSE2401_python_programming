...
print(f"First temperature: {temp_series_indexed.iloc[0]} degrees Farhrenheit.")
print(f"Last temperature: {temp_series_indexed.iloc[-1]} degrees Farhrenheit.")
print()
print(f"Using the label index 'loc()' function")
print(f"Monday's temperature: {temp_series_indexed.loc['Mon']} degrees Farhrenheit.")
print(f"Friday's temperature: {temp_series_indexed.loc['Fri']} degrees Farhrenheit.")
print("-" *50)
